...
import { delete$ } from '../fn/agent-cinema/delete';
import { Delete$Params } from '../fn/agent-cinema/delete';
import { get } from '../fn/agent-cinema/get';
import { Get$Params } from '../fn/agent-cinema/get';
import { post } from '../fn/agent-cinema/post';
import { Post$Params } from '../fn/agent-cinema/post';
import { put } from '../fn/agent-cinema/put';
import { Put$Params } from '../fn/agent-cinema/put';

@Injectable({ providedIn: 'root' })
export class AgentCinemaService extends BaseService {
